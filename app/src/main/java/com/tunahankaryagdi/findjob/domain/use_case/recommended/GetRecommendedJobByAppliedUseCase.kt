...
class GetRecommendedJobByAppliedUseCase @Inject constructor(private val recommendedRepository: RecommendedRepository) {
    ...
    operator fun invoke(userId: String) : Flow<Resource<List<Job>>> {
        ...
        return flow {
            ...
            try {
                val response = recommendedRepository.getRecommendedJobByApplied(userId)
